...
const Vector2 SCREEN_POS_CENTER_LEFT_1       = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2 - 400};
const Vector2 SCREEN_POS_CENTER_RIGHT_1      = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2 - 400};
const Vector2 SCREEN_POS_CENTER_2            = {(float)SCREEN_WIDTH / 2, (float)SCREEN_HEIGHT / 2 - 300};
const Vector2 SCREEN_POS_CENTER_LEFT_2       = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2 - 300};
const Vector2 SCREEN_POS_CENTER_RIGHT_2      = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2 - 300};
const Vector2 SCREEN_POS_CENTER_3            = {(float)SCREEN_WIDTH / 2, (float)SCREEN_HEIGHT / 2 - 200};
const Vector2 SCREEN_POS_CENTER_LEFT_3       = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2 - 200};
const Vector2 SCREEN_POS_CENTER_RIGHT_3      = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2 - 200};
const Vector2 SCREEN_POS_CENTER_4            = {(float)SCREEN_WIDTH / 2, (float)SCREEN_HEIGHT / 2 - 100};
const Vector2 SCREEN_POS_CENTER_LEFT_4       = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2 - 100};
const Vector2 SCREEN_POS_CENTER_RIGHT_4      = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2 - 100};
const Vector2 SCREEN_POS_CENTER_5            = {(float)SCREEN_WIDTH / 2, (float)SCREEN_HEIGHT / 2};
const Vector2 SCREEN_POS_CENTER_LEFT_5       = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2};
const Vector2 SCREEN_POS_CENTER_RIGHT_5      = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2};
const Vector2 SCREEN_POS_CENTER_6            = {(float)SCREEN_WIDTH / 2, (float)SCREEN_HEIGHT / 2 + 100};
const Vector2 SCREEN_POS_CENTER_LEFT_6       = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2 + 100};
const Vector2 SCREEN_POS_CENTER_RIGHT_6      = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2 + 100};
const Vector2 SCREEN_POS_CENTER_7            = {(float)SCREEN_WIDTH / 2, (float)SCREEN_HEIGHT / 2 + 200};
const Vector2 SCREEN_POS_CENTER_LEFT_7       = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2 + 200};
const Vector2 SCREEN_POS_CENTER_RIGHT_7      = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2 + 200};
...
const Vector2 SCREEN_POS_CENTER_BOTTOM_LEFT  = {(float)SCREEN_WIDTH / 2 - 700, (float)SCREEN_HEIGHT / 2 + SCREEN_HEIGHT / 3};
const Vector2 SCREEN_POS_CENTER_BOTTOM_RIGHT = {(float)SCREEN_WIDTH / 2 + 700, (float)SCREEN_HEIGHT / 2 + SCREEN_HEIGHT / 3};
